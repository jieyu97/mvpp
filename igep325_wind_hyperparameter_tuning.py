...
def igep325_es(params):
    ...
    # y_positive = layers.Lambda(lambda x: math.log((1 + 1000**x),1000))(y)
    # y_positive = layers.ReLU(negative_slope=0)(y)
    ...
    ES = es_sample(y=np.reshape(test_y.values, (-1,DIM)), dat=pre_dat)
...
pickle.dump(trials_m2, open('trials_ig325.p', "wb"))
