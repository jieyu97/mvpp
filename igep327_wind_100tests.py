...
for k in range(x):
    ...
    file_name_l = "ig327_ws_10dim_long_" + str(k) + ".csv"
    ens_m3_long_result.to_csv('/Data/Jieyu_data/ig327_ws_all/' + file_name_l)

    file_name_s = "ig327_ws_10dim_short_" + str(k) + ".csv"
    ens_m3_short_result.to_csv('/Data/Jieyu_data/ig327_ws_all/' + file_name_s)
