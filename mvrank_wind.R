...
load("/home/chen_jieyu/IGEP/igfinal_ws_20dim_multi.RData")
...
path_igep = '/home/chen_jieyu/IGEP/ig325_wind_fixhp/'

for (n in 1:an) {
  print(n)
  pn = n-1
  ig2aux_eval_all = read.csv(paste0(path_igep,"ws_20dim_ig325_",pn,".csv"))
