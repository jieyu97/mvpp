...
path_igep1 = '/home/chen_jieyu/IGEP/ig326_tem_fixhp/'
...
for (n in 1:an) {
  ...
  ig322_eval_all = read.csv(paste0(path_igep1,"t2m_5dim_ig326_",pn,".csv"))
...
save.image("/home/chen_jieyu/IGEP/igfinal_t2m_5dim_uni.RData")
