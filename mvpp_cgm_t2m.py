...
for k in range(n_rep):
    ...
    # Model
    BATCH_SIZE = 64  
    LATENT_DIST = dist   # or normal # family of latent varaible distributions
    DIM_LATENT = 10 # 20           # number of latent variables
    ...
    file_name = var + "_" + str(dim) + "dim_newcgm_sa" + str(k+1) + ".csv"
